...
class PremiereScreeningPolicyTest {
    ...
    public void premiere_screening_cannot_start_before_certain_hour() {
        // given a cinema
        var policy = new PremiereShowPolicy((movie) -> false, time("17:00"));
        ...
        Assertions.assertThat(result).contains(new PremiereShowPolicy.BeforePremiereScreeningTime(time("17:00")));
    }
